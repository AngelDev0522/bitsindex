...
const urlsToCache = [
  ...
  '/js/localforage.js',
  '/js/popper.min.js',
  '/js/qrcode-web-worker.js',
  '/img/qrscan/qr-phone.png',
  '/img/qrscan/drawable-xhdpi-icon.png',
  '/img/qrscan/drawable-xxhdpi-icon.png',
  '/img/qrscan/drawable-xxxhdpi-icon.png',
  '/img/qrscan/qr-bg.jpg',
];
