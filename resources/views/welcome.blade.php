            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    ...
                    @if(Auth::check())
                        ...
                        @endif
                        <li><a class="" href="{{ url('/logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
                    ...
                    @else
                        ...
                        <li><a class="" href="{{ url('/qr-activate') }}">Register</a></li>
                    @endif
                    </ul>
                </div>
            </div>
...
<script src="{{ URL::asset('/Inspina/js/plugins/wow/wow.min.js') }}"></script>
